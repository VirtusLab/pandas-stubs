...
from pandas.core.frame import SortKind, NaSortPosition
...
class NDFrame(PandasObject, SelectionMixin, indexing.IndexingMixin):
    ...
    def rename(self, mapper: Optional[Renamer]=..., *, index: Optional[Renamer]=..., columns: Optional[Renamer]=..., axis: Optional[Axis]=..., copy: bool_t=..., inplace: bool_t=..., level: Optional[Level]=..., errors: str=...) -> Optional[FrameOrSeries]: ...
    ...
    @overload
    def __getitem__(self, key: Column) -> FrameOrSeries: ...
    @overload
    def __getitem__(self, key: Sequence[Column]) -> FrameOrSeries: ...
    @overload
    def __getitem__(self, key: slice) -> FrameOrSeries: ...
    ...
    def sort_values(self, by: Union[str, List[str]] = ..., axis: int = ..., ascending: bool_t = ..., inplace: bool_t = ..., kind: str = ..., na_position: str = ..., ignore_index: bool_t = ...) -> Optional[FrameOrSeries]: ...
    def sort_index(self, axis: Any = ..., level: Any = ..., ascending: bool_t=..., inplace: bool_t=..., kind: SortKind = ..., na_position: NaSortPosition = ..., sort_remaining: bool_t=..., ignore_index: bool_t=...) -> Any: ...
    ...
    def align(self, other: Any, join: str = ..., axis: Optional[Any] = ..., level: Optional[Any] = ..., copy: bool_t = ..., fill_value: Optional[Any] = ..., method: Optional[Any] = ..., limit: Optional[Any] = ..., fill_axis: int = ..., broadcast_axis: Optional[Any] = ...) -> Any: ...
