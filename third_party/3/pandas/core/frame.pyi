...
class DataFrame(NDFrame):
    ...
    def sort_values(self, by: Union[str, List[str]], axis: AxisOption = ..., ascending: bool = ..., inplace: bool = ..., kind: SortKind = ..., na_position: NaSortPosition = ..., ignore_index: bool = ...,  key: ValueKeyFunc = ...) -> Optional[DataFrame]: ...   # type: ignore[override]
    def sort_index(self, axis: AxisOption = ..., level: Optional[Union[Level, List[Level]]] = ..., ascending: bool = ..., inplace: bool = ..., kind: SortKind = ..., na_position: NaSortPosition = ..., sort_remaining: bool = ..., ignore_index: bool = ...,  key: IndexKeyFunc = ...) -> Optional[DataFrame]: ...
    ...
    def compare(self, other: DataFrame, align_axis: Union[str, int] = ..., keep_shape: bool = ..., keep_equal: bool = ...) -> DataFrame: ...
