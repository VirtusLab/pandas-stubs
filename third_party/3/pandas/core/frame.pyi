...
class DataFrame(NDFrame):
    ...
    def align(self, other: FrameOrSeries, join: JoinType = ..., axis: Any = ..., level: Any = ..., copy: bool = ..., fill_value: Scalar = ..., method: Optional[Any] = ..., limit: Optional[int] = ..., fill_axis: Any = ..., broadcast_axis: Any = ...) -> DataFrame: ...
