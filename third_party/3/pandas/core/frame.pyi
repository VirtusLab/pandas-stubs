...
ColumnMapping = TypeVar("ColumnMapping", bound=Mapping[Column, Any])
...
class DataFrame(NDFrame):
    ...
    # Dict is the default type if not specified
    @overload
    ...
    @overload
    def to_dict(self, into: Type[ColumnMapping]) -> ColumnMapping: ...
    @overload
    def to_dict(self, orient: ExportOrientationMapping, into: Type[ColumnMapping]) -> ColumnMapping: ...
    @overload
    def to_dict(self, orient: ExportOrientationList, into: Type[ColumnMapping]) -> List[ColumnMapping]: ...
