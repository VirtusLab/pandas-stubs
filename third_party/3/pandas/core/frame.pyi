...
class DataFrame(NDFrame):
    ...
    @overload
    def drop(self, labels: Optional[Iterable[Label]] = ..., axis: AxisOption = ..., index: Optional[Iterable[Label]] = ..., columns: Optional[Iterable[Label]] = ..., level: Optional[Level] = ..., errors: ErrorsStrategy = ..., *, inplace: Literal[False] = ...) -> DataFrame: ...
    @overload
    def drop(self, labels: Optional[Iterable[Label]] = ..., axis: AxisOption = ..., index: Optional[Iterable[Label]] = ..., columns: Optional[Iterable[Label]] = ..., level: Optional[Level] = ..., errors: ErrorsStrategy = ..., *, inplace: Literal[True]) -> None: ...
    @overload
