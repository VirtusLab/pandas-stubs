...
from pandas._typing import Axes, Axis, Dtype as Dtype, FilePathOrBuffer, Level, Renamer, Column, Label, FrameOrSeries, \
    ...
    Orientation, Function, MultipleAggregationFunctions, FunctionOrName, AggregationFunction, GroupByObject, GeneralDuplicatesKeepStrategy, InterpolationMethod, \
...
class DataFrame(NDFrame):
    ...
    # Less precise type to nudge folks towards `.agg`
    def aggregate(self, func: AggregationFunction = ..., axis: AxisOption = ..., *args: Any, **kwargs: Any) -> Union[Scalar, FrameOrSeries]: ...
    @overload
    def agg(self, func: MultipleAggregationFunctions = ..., axis: AxisOption = ..., *args: Any, **kwargs: Any) -> DataFrame: ...
    @overload
    def agg(self, func: Union[Callable[..., Any], str], axis: AxisOption = ..., *args: Any, **kwargs: Any) -> Series: ...
    # If numpy is not available to mypy, np.func will be `Any` and can't be used for overloading
    @overload
    def agg(self, func: np.func, axis: AxisOption = ..., *args: Any, **kwargs: Any) -> FrameOrSeries: ...
