...
class NDFrame(PandasObject, SelectionMixin, indexing.IndexingMixin):
    ...
    def sort_values(self, by: Union[str, List[str]] = ..., axis: int = ..., ascending: bool_t = ..., inplace: bool_t = ..., kind: str = ..., na_position: str = ..., ignore_index: bool_t = ...,  key: ValueKeyFunc = ...) -> Optional[FrameOrSeries]: ...
    def sort_index(self, axis: Any = ..., level: Any = ..., ascending: bool_t=..., inplace: bool_t=..., kind: SortKind = ..., na_position: NaSortPosition = ..., sort_remaining: bool_t=..., ignore_index: bool_t=..., key: IndexKeyFunc = ...) -> Any: ...
