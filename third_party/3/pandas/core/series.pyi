...
class Series(base.IndexOpsMixin, generic.NDFrame):
    ...
    def __mul__(self, other: Scalar) -> Series: ...
    def __add__(self, other: Scalar) -> Series: ...
    ...
    def rename(self, index: Optional[Renamer] = ..., *, axis: Optional[OneDimensionalAxisOption] = ..., copy: bool = ..., inplace: bool = ..., level: Optional[Level] = ..., errors: ErrorsStrategy = ...) -> Optional[Series]: ...   # type: ignore[override]
