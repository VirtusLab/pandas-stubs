...
from pandas._typing import Renamer, FrameOrSeries, Function, AxisOption, Frequency, Scalar, Dtype, \
    ...
    SortKind, \
    MultipleAggregationFunctions, FunctionOrName, AggregationFunction, JoinType, FillMethod, ErrorsStrategy, FillValue, ToReplace, ReplaceValue, \
    TimestampMethod, \
...
class Series(base.IndexOpsMixin, generic.NDFrame):
    ...
    @overload
    def agg(self, func: MultipleAggregationFunctions = ..., axis: OneDimensionalAxisOption = ..., *args: Any, **kwargs: Any) -> Series: ...
    # Should return Scalar, but as a large Union it would almost always require a cast
    # Return `Any` instead for better ergonomics
    @overload
    def agg(self, func: FunctionOrName, axis: OneDimensionalAxisOption = ..., *args: Any, **kwargs: Any) -> Any: ...
