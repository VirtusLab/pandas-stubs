...
class Series(base.IndexOpsMixin, generic.NDFrame):
    ...
    @overload  #type: ignore[override]
    def rename(self, index: Union[Renamer, Scalar] = ..., *, axis: Optional[OneDimensionalAxisOption] = ..., copy: bool = ..., inplace: Literal[False] = ..., level: Optional[Level] = ..., errors: ErrorsStrategy = ...) -> Series: ...
    @overload
    def rename(self, index: Union[Renamer, Scalar] = ..., *, axis: Optional[OneDimensionalAxisOption] = ..., copy: bool = ..., inplace: Literal[True], level: Optional[Level] = ..., errors: ErrorsStrategy = ...) -> None: ...
