...
def to_gbq(dataframe: DataFrame, destination_table: str, project_id: Optional[str]=..., chunksize: Optional[int]=..., reauth: bool=..., if_exists: str=..., auth_local_webserver: bool=..., table_schema: Optional[List[Dict[str, str]]]=..., location: Optional[str]=..., progress_bar: bool=..., credentials: Any = ..., verbose: Any = ..., private_key: Any = ...) -> None: ...
