...
def process_skipna(skipna: Any, args: Any) -> Any: ...
def validate_argmin_with_skipna(skipna: Any, args: Any, kwargs: Any) -> Any: ...
def validate_argmax_with_skipna(skipna: Any, args: Any, kwargs: Any) -> Any: ...
...
def validate_argsort_with_ascending(ascending: Any, args: Any, kwargs: Any) -> Any: ...

CLIP_DEFAULTS: Any
validate_clip: Any

def validate_clip_with_axis(axis: Any, args: Any, kwargs: Any) -> Any: ...

CUM_FUNC_DEFAULTS: OrderedDict[str, Any]
validate_cum_func: Any
validate_cumsum: Any

def validate_cum_func_with_skipna(skipna: Any, args: Any, kwargs: Any, name: Any) -> Any: ...
