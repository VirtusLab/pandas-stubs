...
class NDFrame(PandasObject, SelectionMixin, indexing.IndexingMixin):
    ...
    @property
    def size(self) -> Any: ...
    def set_axis(self, labels: Any, axis: int = ..., inplace: bool = ...) -> Any: ...
    ...
    def sort_values(self, by: Any = ..., axis: Any = ..., ascending: bool_t = ..., inplace: bool_t=..., kind: str=..., na_position: str=..., ignore_index: bool_t=...) -> Any: ...
    ...
    def replace(self, to_replace: Optional[Any] = ..., value: Optional[Any] = ..., inplace: bool_t = ..., limit: Optional[Any] = ..., regex: bool_t = ..., method: str = ...) -> Any: ...
