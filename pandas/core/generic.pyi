from typing import Any, Callable, Dict, Hashable, List, Mapping, Optional, Sequence, Tuple, Union, AnyStr

import numpy as np
import pandas.core.indexing as indexing
from pandas._typing import Axis, Dtype, FilePathOrBuffer, FrameOrSeries, JSONSerializable, Level, Renamer, \
    ReplaceMethod, ReplaceValue, ToReplace, Frequency, Scalar, AxisOption
...
class NDFrame(PandasObject, SelectionMixin, indexing.IndexingMixin):
    ...
    def shift(self, periods: int = ..., freq: Frequency = ..., axis: AxisOption = ..., fill_value: Scalar = ...) -> FrameOrSeries: ...
