...
class Series(base.IndexOpsMixin, generic.NDFrame):
    ...
    @property
    def axes(self) -> Any: ...
    def take(self, indices: Any, axis: Any = ..., is_copy: Any = ..., **kwargs: Any) -> Series: ...
    ...
    def sort_values(self, axis: int = ..., ascending: bool = ..., inplace: bool = ..., kind: str = ..., na_position: str = ..., ignore_index: bool = ...) -> Any: ...
    ...
    def rename(self, index: Optional[Any] = ..., *, axis: Optional[Any] = ..., copy: bool = ..., inplace: bool = ..., level: Optional[Any] = ..., errors: str = ...) -> Any: ...
    def reindex(self, index: Optional[Any] = ..., **kwargs: Any) -> Any: ...
